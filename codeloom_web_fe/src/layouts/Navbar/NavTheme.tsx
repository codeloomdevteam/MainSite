...
const NavTheme = (props: Props) => {
  ...
  // Update DOM and localStorage when theme changes — but only if theme is valid
  useEffect(() => {
    if (theme) {
  ...
  return (
    <>
      <label className="swap swap-rotate">
        ...
        <input
          type="checkbox"
          checked={theme === "business"} // Check if the theme is dark
          onChange={toggleTheme} // Call themeValue when clicked
        />
